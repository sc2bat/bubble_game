...
game_result = None
# 충돌 처리를 통해 버블을 없애고 bubble_group 내 버블이 모두 없으면 게임종료로
...
while running:
    ...
    # bubble_group 내 버블이 없다면 게임종료
    if not bubble_group:
        game_result = "Mission Complete"
        is_game_over = True
    # 위치해 있는 버블들 중 가장 아래쪽의 버블이 선보다 높이가 커지면(아래로 내려오면) 게임 종료
    # len : map 의 row 기준으로 가져옴
